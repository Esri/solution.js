...
describe("object-helpers", () => {
  describe("getDeepValues", () => {
    ...
    it("only looks at own props", () => {
      ...
      child.childProp = "red";
      expect(getDeepValues(child, "childProp")).toEqual(
        ["red"],
        "finds own prop"
      );
      expect(getDeepValues(child, "prop")).toEqual(
        [],
        "does not find parent prop"
      );
    });
    ...
    it("plucks a top level value", () => {
      ...
      expect(getDeepValues(m, "webmap")).toEqual(
        ["3ef"],
        "finds top level prop"
      );
    });
    ...
    it("looks into arrays", () => {
      ...
      expect(chk2[0] as any).toEqual(
        { id: "in-the-obj" },
        "should find first obj"
      );
      expect(chk2[1] as any).toEqual(
        { id: "three-deep" },
        "should find nested obj"
      );
      expect(chk2[2] as any).toEqual(
        { id: "two-arrys" },
        "should find nested obj"
      );
    });
