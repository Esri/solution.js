...
export function getFourItemFeatureServiceTemplatePart(): any {
  ...
  const layer2: any = removeEditFieldsInfoField(
    getLayerOrTableTemplate(2, "ROW Permits layer 2", "Feature Layer")
  );
  const layer3: any = removeEditFieldsInfoField(
    getLayerOrTableTemplate(3, "ROW Permits layer 3", "Feature Layer")
  );
...
export function getWebMappingApplicationTemplate(): mInterfaces.ITemplate[] {
...
export function getWebMappingApplicationTemplateGroup(): mInterfaces.ITemplate[] {
  const template: mInterfaces.ITemplate[] = [
    getItemTemplatePart(
      "Web Mapping Application",
      ["map1234567890"],
...
export function getWebMappingApplicationTemplateNoWebmapOrGroup(): mInterfaces.ITemplate[] {
  const template: mInterfaces.ITemplate[] = [
    getItemTemplatePart(
      "Web Mapping Application",
      null,
