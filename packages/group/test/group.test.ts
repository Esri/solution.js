...
describe("Module `group`: manages the creation and deployment of groups", () => {
  ...
  describe("getGroupTitle", () => {
    it("return a valid title", () => {
      ...
      const result: string = group.getAvailableGroupTitle(
        name,
        templateDictionary
      );
    ...
    it("return a valid title when the current title is not available", () => {
      const name: string = "Dam Inspection Assignments";
      const templateDictionary: any = {
        user: {
          groups: [
      ...
      const expected: string = "Dam Inspection Assignments 1";
    ...
    it("return a valid title when the current title is not available and the title + 1 is also not available", () => {
      const name: string = "Dam Inspection Assignments";
      const templateDictionary: any = {
        user: {
          groups: [
            ...
            {
              title: "Dam Inspection Assignments 1"
            },
            {
              title: "Dam Inspection Assignments 3"
            }
          ]
        }
      };

      const expected: string = "Dam Inspection Assignments 2";
