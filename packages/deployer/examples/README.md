...
## solution-deployer package examples

These examples illustrate the use of the solution-deployer package.

### deploySolution

Deploys a solution using its AGO id.

### implementedTypes

Lists the AGO item types supported or in progress to be supported.
