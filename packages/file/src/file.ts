...
export function convertItemToTemplate(
  ...
  return new Promise<common.IItemTemplate>((resolve) => {
    ...
    const dataPromise = new Promise<File>((dataResolve) => {
      ...
      common.getItemDataAsFile(itemTemplate.itemId, itemTemplate.item.name, srcAuthentication).then((response) => {
    ...
    const relatedPromise = Promise.resolve({} as common.IGetRelatedItemsResponse);
