...
describe("simpleTypeConvertItemToTemplate", () => {
  describe("dashboard", () => {
    it("should handle dashboard et al. item types", async() => {
      ...
      fetchMock
        .post(utils.PORTAL_SUBSET.restUrl + "/content/items/" + itemTemplate.itemId + "/data", ["abc", "def", "ghi"])
        .post(utils.PORTAL_SUBSET.restUrl + "/content/items/" + itemTemplate.itemId + "/resources", noResourcesResponse)
        .post(
    ...
    describe("form", () => {
      ...
      beforeEach(async() => {
        ...
        fetchMock
          .post(utils.PORTAL_SUBSET.restUrl + "/content/items/" + itemTemplate.itemId + "/data", ["abc", "def", "ghi"])
          .post(
            utils.PORTAL_SUBSET.restUrl + "/content/items/" + itemTemplate.itemId + "/resources",
            noResourcesResponse,
          )
          .post(
            utils.PORTAL_SUBSET.restUrl + "/content/items/" + itemTemplate.itemId + "/info/metadata/metadata.xml",
      ...
      it("should handle form item type with default filename for falsy item name", async() => {
        ...
        spyOn(common, "getItemDataAsFile").and.resolveTo(
          await zipHelpers.getSampleFormZipFile(formId, "frm1234567890.zip"),
        );
  ...
  describe("notebook", () => {
    it("should handle python notebook", async() => {
      ...
      fetchMock
        ...
        .post(utils.PORTAL_SUBSET.restUrl + "/content/items/abc0cab401af4828a25cc6eaeb59fb69/data", dataResponse)
        .post(
          utils.PORTAL_SUBSET.restUrl + "/content/users/casey/items/sln1234567890/addResources",
          utils.getSuccessResponse(),
        )
      ...
      expect(newItemTemplate.data).toEqual(templates.getItemTemplateData("Notebook"));
    });
  });
  ...
  describe("oic", () => {
    it("should handle OIC (Oriented Imagery Catalog)", async() => {
      ...
      fetchMock
        .post(utils.PORTAL_SUBSET.restUrl + "/content/items/oic1234567890/data", data)
        .post("https://services.arcgis.com/64491f8c348a51cf/arcgis/rest/services/OIC_FL_002/FeatureServer/0", service);
  ...
  describe("quick capture", () => {
    it("should handle quick capture project", async() => {
      ...
      fetchMock
        .post(utils.PORTAL_SUBSET.restUrl + "/content/items/qck1234567890/data", utils.getSampleQCJsonData())
        ...
        .post(
          utils.PORTAL_SUBSET.restUrl + "/content/items/qck1234567890/info/thumbnail/ago_downloaded.png",
          utils.getSampleImageAsBlob(),
          { sendAsJson: false },
        )
        .post(
          utils.PORTAL_SUBSET.restUrl + "/content/items/qck1234567890/resources/qc.project.json",
      ...
      const itemInfo: common.IItemTemplate = mockItems.getAGOLItem("QuickCapture Project", undefined);
      ...
      const actual = await simpleTypes.convertItemToTemplate(itemInfo, MOCK_USER_SESSION, MOCK_USER_SESSION, {});
    ...
    it("should handle quick capture project without a data section", async() => {
      ...
      fetchMock
        .post(utils.PORTAL_SUBSET.restUrl + "/content/items/qck1234567890/data", mockItems.get400Failure())
        .post(utils.PORTAL_SUBSET.restUrl + "/content/items/qck1234567890/resources", resources)
        .post(
          utils.PORTAL_SUBSET.restUrl + "/content/items/qck1234567890/info/metadata/metadata.xml",
          mockItems.get500Failure(),
    ...
    it("should handle quick capture project without a basemap", async() => {
      ...
      const qcProjectJson = new File([utils.jsonToBlob({})], "qc.project.json", { type: "application/json" });
      ...
      fetchMock
        ...
        .post(utils.PORTAL_SUBSET.restUrl + "/content/items/qck1234567890/resources/qc.project.json", qcProjectJson, {
          sendAsJson: false,
        })
        .post(utils.PORTAL_SUBSET.restUrl + "/content/users/casey/items/" + solutionItemId + "/addResources", {
          success: true,
  ...
  describe("vector tile service", () => {
    it("should handle vector tile service", async() => {
      ...
      fetchMock
        .post(utils.PORTAL_SUBSET.restUrl + "/content/items/vts1234567890/resources", [])
        .post(
      ...
      staticRelatedItemsMocks.fetchMockRelatedItems("vts1234567890", { total: 0, relatedItems: [] });

      const actual = await simpleTypes.convertItemToTemplate(
        itemTemplate.item,
        MOCK_USER_SESSION,
        MOCK_USER_SESSION,
        {},
  ...
  describe("web mapping application", () => {
    it("should handle web mapping application", async() => {
      ...
      itemTemplate.item = {
        ...
        contentStatus: null,
        url: "https://myOrg.arcgis.com/home/item.html?id=abc123da3c304dd0bf46dee75ac31aae",
        created: 1520968147000,
        modified: 1522178539000,
      };
      ...
      fetchMock
        .post(utils.PORTAL_SUBSET.restUrl + "/content/items/abc0cab401af4828a25cc6eaeb59fb69/resources", [])
        .post(
          utils.PORTAL_SUBSET.restUrl + "/content/items/abc0cab401af4828a25cc6eaeb59fb69/data",
          new Blob([JSON.stringify(itemTemplate.data)], {
            type: "application/json",
          }),
          { sendAsJson: false },
    ...
    it("should handle error on web mapping application: feature layer", async() => {
      ...
      fetchMock
        ...
        .post("https://fake.com/arcgis/rest/info", {})
        .post(utils.PORTAL_SUBSET.restUrl + "/content/items/abc0cab401af4828a25cc6eaeb59fb69/resources", [])
        .post(utils.PORTAL_SUBSET.restUrl + "/content/items/abc0cab401af4828a25cc6eaeb59fb69/data", data)
        .post(
          utils.PORTAL_SUBSET.restUrl + "/content/users/casey/items/sln1234567890/addResources",
          utils.getSuccessResponse(),
        )
        .post("https://fake.com/arcgis/rest/services/test/FeatureServer/0", mockItems.get400FailureResponse());
      staticRelatedItemsMocks.fetchMockRelatedItems("abc0cab401af4828a25cc6eaeb59fb69", { total: 0, relatedItems: [] });

      return simpleTypes.convertItemToTemplate(itemTemplate.item, MOCK_USER_SESSION, MOCK_USER_SESSION, {}).then(
        () => fail(),
        () => Promise.resolve(),
      );
    });
    ...
    it("should handle web mapping application with missing data section and source URL", async() => {
      ...
      fetchMock
        .post(utils.PORTAL_SUBSET.restUrl + "/content/items/" + itemTemplate.itemId + "/data", 200)
        .post(utils.PORTAL_SUBSET.restUrl + "/content/items/" + itemTemplate.itemId + "/resources", noResourcesResponse)
        .post(
          utils.PORTAL_SUBSET.restUrl + "/content/items/" + itemTemplate.itemId + "/info/metadata/metadata.xml",
          mockItems.get400Failure(),
  ...
  describe("workforce", () => {
    it("should handle workforce project", async() => {
      ...
      fetchMock
        ...
        .post(utils.PORTAL_SUBSET.restUrl + "/content/items/abc0cab401af4828a25cc6eaeb59fb69/data", dataResponse)
        .get(utils.PORTAL_SUBSET.restUrl + "/community/groups/grp1234567890?f=json&token=fake-token", {});
      staticRelatedItemsMocks.fetchMockRelatedItems("abc0cab401af4828a25cc6eaeb59fb69", { total: 0, relatedItems: [] });
