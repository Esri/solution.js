...
let mapDataResponse: any;
let featureServiceItemResponse: any;
let externalDatasourceResponse: any;
let webmapFeatureServiceResponse: any;
let baseItemTemplate: interfaces.IItemTemplate;
let baseExpectedItemTemplate: interfaces.IItemTemplate;
let baseWidgets: any[];
let baseHeaderPanel: any;
let baseLeftPanel: any;
let baseUrlParameters: any[];

beforeEach(() => {
  initialDashboardTemplate = common.cloneObject(_initialDashboardTemplate);
  mapDataResponse = common.cloneObject(_mapDataResponse);
  featureServiceItemResponse = common.cloneObject(_featureServiceItemResponse);
  externalDatasourceResponse = common.cloneObject(_externalDatasourceResponse);
  webmapFeatureServiceResponse = common.cloneObject(
    _webmapFeatureServiceResponse
  );
  baseItemTemplate = common.cloneObject(_baseItemTemplate);
  baseExpectedItemTemplate = common.cloneObject(_baseItemTemplate);
  baseWidgets = common.cloneObject(_baseWidgets);
  baseHeaderPanel = common.cloneObject(_baseHeaderPanel);
  baseLeftPanel = common.cloneObject(_baseLeftPanel);
  baseUrlParameters = common.cloneObject(_baseUrlParameters);
});
...
describe("Module `dashboard`: manages the creation and deployment of dashboard item type", () => {
  describe("convertItemToTemplate", () => {
    if (typeof window !== "undefined") {
      it("should templatize webmap ids and external datasource ids", done => {
        ...
        dashboard
          .convertItemToTemplate(initialDashboardTemplate, MOCK_USER_SESSION)
          .then(
            updatedTemplate => {
  ...
  describe("_extractDependencies", () => {
    if (typeof window !== "undefined") {
      it("should extract dependencies", done => {
        ...
        dashboard
          ._extractDependencies(initialDashboardTemplate, MOCK_USER_SESSION)
          .then(
            results => {
  ...
  describe("_templatize", () => {
    xit("should templatize widgets", () => {
      // this function only templatizes field references currently
      // may re-think as I migrate this to the postProcess approach
      baseItemTemplate.data = {
        widgets: baseWidgets
      };
      baseExpectedItemTemplate.data = {
        widgets: expectedWidgets
      };
      const actual: interfaces.IItemTemplate = dashboard._templatize(
        baseItemTemplate,
        datasourceInfos
      );
      expect(actual).toEqual(baseExpectedItemTemplate);
    });

    // it("should headerPanel selectors", () => {

    // });

    // it("should leftPanel selectors", () => {

    // });

    // it("should urlParameters", () => {
...
const datasourceInfos: interfaces.IDatasourceInfo[] = [
  {
    ...
    ids: [
      "7866f4bd-8361-4205-8fd7-f92da41fdb61",
      "b90fa68a-1817-40a2-91c4-1738f5b37e7e",
      "2ccc8953-1958-40c0-b237-689a39d5904b",
      "c220e9bb-f0b9-4f0e-93e8-8baa3f39aa0c",
      "27daba1f-9223-4013-8ca8-797388fd2116",
      "bd1eec15-c178-4929-b800-936be1e6789b",
      "be4aad77-c0c3-42f5-8a74-53dfc79f6558",
      "2f547ec0-cd71-4b05-b28a-a467793d7601",
      "f81f2270-e104-453d-9c09-045d8d1087c9",
      "90ebe87f-b8b4-4f1c-bc1c-313a2a799c80",
      "238a75d4-4a35-4747-918a-d2353b1698bd",
      "bfbc8214-5549-4fe7-a919-d7857ce0ea16",
      null
    ]
  },
  {
    ...
    url:
      "https://services7.arcgis.com/piPfTFmrV9d1DIvN/arcgis/rest/services/LayerForDashboardExteternal/FeatureServer/0",
    fields: [
      {
        name: "OBJECTID",
        type: "esriFieldTypeOID",
    ...
    ids: [
      "8830ce79-2010-408d-838c-93b1afd6308a",
      "e321f855-d6c0-4bf5-9c2a-861db15fe877",
      "161e9532-317f-4ce2-acea-445b1c4dae59",
      "ecf67bd0-3b15-4920-877a-7b02f28a9d4a",
      "79de7d45-0586-43fa-91e6-9d020c88d2d3",
      "0ef05811-5ef1-4079-b8c3-68671d1d2a77",
      "a78ee2ac-bfe2-4a4c-a477-1d4abb76419a",
      null
    ]
  }
];

const _baseItemTemplate: interfaces.IItemTemplate = {
...
const expectedUrlParameters: any[] = [
  {
    datasets: [
      {
        type: "serviceDataset",
...
const _initialDashboardTemplate: any = {
  itemId: "eff3f22d41ad42dcb6fe9015f26d40f4",
  type: "Dashboard",
  key: "w5u0o8te",
  item: {
...
const _featureServiceItemResponse: any = {
...
const _externalDatasourceResponse: any = {
  id: 0,
  name: "Hospital",
  type: "Feature Layer",
  description: "",
...
const _webmapFeatureServiceResponse: any = {
  id: 2,
