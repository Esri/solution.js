...
describe('Story Maps :: ', () => {
  describe('generic functions', () => {
    ...
    describe('getting dependencies', () => {
      it('can get dependencies for a cascade', () => {
        ...
        expect(r.indexOf('234a94478490445cb4a57878451cb4b8')).not.toEqual(-1);
        expect(r.indexOf('7db923b748c44666b09afc83ce833b87')).not.toEqual(-1);
      });
  ...
  describe('Cascade :: ', () => {
    it('gets deps from deep in cascade', () => {
      ...
      expect(r.length).toEqual(4, 'should find 4');
      expect(r.indexOf('234a94478490445cb4a57878451cb4b8')).not.toEqual(-1);
      expect(r.indexOf('7db923b748c44666b09afc83ce833b87')).toBeTruthy();
    });
