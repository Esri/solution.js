  ...
  describe("parseIdFromUrl", () => {
    it("works for common types", () => {
      const examples = [
        ...
        {
          url:
            "https://www.arcgis.com/home/webscene/viewer.html?webmap=81b46c2b162c48dba264b2190e1dbcff&ui=min",
          expected: "81b46c2b162c48dba264b2190e1dbcff"
        },
        {
          url:
            "https://www.arcgis.com/home/webscene/viewer.html?webmap=notaguid&ui=min",
          expected: null
        },
        {
