...
describe("formUtils", () => {
  describe("swizzleFormObject", () => {
    it("swizzles a form object", async () => {
      ...
      const expectedZipObject = zipHelpers.generateFormZipObject("0c01725576b640e4bd25a16721850001");
    ...
    it("skips no-ops", async () => {
      ...
      const expectedZipObject = zipHelpers.generateFormZipObject("0c01725576b640e4bd25a16721850000");
      const expectedZipContents = await common.getZipObjectContents(expectedZipObject);
    ...
    it("doesn't swizzle the wrong items", async () => {
      ...
      const expectedZipObject = zipHelpers.generateFormZipObject("0c01725576b640e4bd25a16721850002");
      const expectedZipContents = await common.getZipObjectContents(expectedZipObject);
    ...
    it("doesn't swizzle a binary object", async () => {
      ...
      const templateDictionary = {
        ...
        "09b843d27d8a441db4c88c1f03b8e9aa": {
          itemId: "c909d4ffd708476789e22664051629a0",
        },
        "bf0b8500dc824f0bbd03dbde294cbec9": {
          itemId: "3abb693e55374947ba60ec7d974e8e92",
        },
      };
  ...
  describe("templatizeFormData", () => {
    ...
    it("templatizes form data", async () => {
      ...
      const expectedZipContents = await common.getZipObjectContents(expectedZipObject);
      expectedZipContents[1].content = (expectedZipContents[1].content as string).replace(
        "https://fred.maps.arcgis.com",
        "{{portalBaseUrl}}",
      );
  ...
  describe("_updateZipObjectTextContent", () => {
    it("modifies text form content", () => {
      const zipFileItem: common.IZipObjectContentItem = {
        file: "file.txt",
        content:
          "This is the bf0b8500dc824f0bbd03dbde294cbec9 {{content}} of {{09b843d27d8a441db4c88c1f03b8e9aa.itemId}}: 774ac2524dad4bf38c369ac1950d8d97 & bf0b8500dc824f0bbd03dbde294cbec9. It is a very important item 3abb693e55374947ba60ec7d974e8e92 for {{content}} and {{bf0b8500dc824f0bbd03dbde294cbec9.itemId}}. But not for 13d47c3960084f8a9effb0451df5ea1b {{content}}.",
      };
      const templateDictionary = {
        "content": "item",
        "09b843d27d8a441db4c88c1f03b8e9aa": {
